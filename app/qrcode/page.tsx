...
export default function ScanPage() {
  ...
  return (
    <div>
      <div className="min-h-screen bg-gradient-to-tr from-cyan-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 flex flex-col justify-center items-center px-4 py-12">
