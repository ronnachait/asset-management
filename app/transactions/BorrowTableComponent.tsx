                  ...
                  return (
                    <tr
                      ...
                      className={cn(
                        ...
                        order.status === "done" && "bg-green-50 dark:bg-gray-700"
                      )}
                    >
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <div className="flex flex-col">
                  <span className="text-xs text-slate-400 dark:text-slate-500">หมายเลข</span>
              ...
              <div className="space-y-2 text-sm text-slate-700">
                <div className="flex items-center gap-2">
                  <span className="font-medium text-slate-500 dark:text-slate-400">👤 ผู้ยืม:</span>
                  <span className="font-medium dark:text-white">{order.accounts.name}</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-medium text-slate-500 dark:text-slate-400">📅 ยืม:</span>
